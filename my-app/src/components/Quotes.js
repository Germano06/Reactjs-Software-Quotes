...
export class Quotes extends Component {
    ...
    render(){
        ...
        return(
       <>
        <center><h1><Link to="/">Quotes</Link></h1></center>
        <form className="d-flex" style={{margin:"30px"}}>
                    <input className="form-control me-2" type="search" placeholder="Search" aria-label="Search"  id="myInput" onChange={this.handleChange}/>
